...
public class Station extends ParseObject {
    ...
    public double getLongitude(){ return getNumber(KEY_LONGITUDE).doubleValue(); }
    public LatLng getCoords(){
        return new LatLng(getLatitude(),getLongitude());
    }
    public int getType(){
        return (int)getNumber(KEY_TYPE);
    }
    ...
    public void setCoords(LatLng latlng){
        put(KEY_LATITUDE,latlng.latitude);
        put(KEY_LONGITUDE,latlng.longitude);
    }
    public void setPublic(){
        put(KEY_TYPE, PUBLIC_TYPE);
    }
    public void setPrivate(){
        put(KEY_TYPE, PRIVATE_TYPE);
    }
